...
while changed == True:
    ...
    if found == True:
        print(f"Знайдено ядерні рядки: {core_rows}")
    found = False
    ...
    if found == True:
        print("Ядерні рядки (та затронуті їми стовпці) успішно видалені з матриці. Тепер вона має вигляд: ")
    ...
    m_c_rows = len(matrix_copy)
    if found == True:
        print(f"Знайдено антиядерні рядки: {anticore_rows}. З матриці успішно видалені, тепер вона має вигляд: ")
        for row in matrix_copy:
            print(row)
    found = False
    ...
    m_c_rows = len(matrix_copy)
    if found == True:
        print(f"Знайдено рядки, які поглинаються: {absorbed_rows}. З матриці успішно видалені, тепер вона має вигляд: ")
        for row in matrix_copy:
            print(row)
    found = False
...
print(f"Знайдено покриття у скороченій матриці. За ціну {best_cost} комбінацією рядків {best_cost_row}. За кількість рядків {best_amount} комбінацією рядків {best_amount_row}.")
...
# Обʼєднуємо рядки з найкращих рішень знаходження покриття з ядерними рядками
