"""
ВЕРСІЯ ДЛЯ ВИВОДУ ВСІХ МОЖЛИВИХ КОМБІНАЦІЙ ПОКРИТТІВ!!!
Програма для побудови покриття методом повного перебору.
6КН-22б, Іщенко Гліб
...
for i in range(7):
    ...
    if Temp == Cover:
        # Видаємо результати
        print(f"Покриття за {row_counter} рядок, а саме {i+1}-й за ціну {cost}.")
    ...
    for o in range(1, 7):
        ...
        if o != i:
            ...
            if Temp == Cover:
                # Видаємо результати
                print(f"Покриття за {row_counter} рядки, а саме {i+1}-й та {o+1}-й за ціну {cost}.")
                # Якщо поставлен рекорд по кількості рядків для покриття
                if row_counter < best_amount:
                    best_amount = row_counter
                    print("РЕКОРД КІЛЬКОСТІ")
                ...
                if p not in [i, o]:
                    for m in range(10):
                        ...
                        if Temp[m] != 1 and matrix[p][m] == 1:
                            Temp[m] = matrix[p][m]
                    if Temp == Cover:
                        print(f"Покриття за {row_counter} рядки, а саме {(i+1), (o+1), (p+1)} за ціну {cost}.")
                        if row_counter < best_amount:
                            best_amount = row_counter
                            print("РЕКОРД КІЛЬКОСТІ")
                        if cost < best_cost:
                        ...
                        if a not in [i, o, p]:
                            for m in range(10):
                                ...
                                if Temp[m] != 1 and matrix[a][m] == 1:
                                    Temp[m] = matrix[a][m]
                            if Temp == Cover:
                                print(f"Покриття за {row_counter} рядки, а саме {(i+1), (o+1), (p+1), (a+1)} за ціну {cost}.")
                                if row_counter < best_amount:
                                    best_amount = row_counter
                                    print("РЕКОРД КІЛЬКОСТІ")
                                if cost < best_cost:
                                ...
                                if s not in [i, o, p, a]:
                                    for m in range(10):
                                        ...
                                        if Temp[m] != 1 and matrix[s][m] == 1:
                                            Temp[m] = matrix[s][m]
                                    if Temp == Cover:
                                        print(f"Покриття за {row_counter} рядків, а саме {(i+1), (o+1), (p+1), (a+1), (s+1)} за ціну {cost}.")
                                        if row_counter < best_amount:
                                            best_amount = row_counter
                                            print("РЕКОРД КІЛЬКОСТІ")
                                        if cost < best_cost:
                                        ...
                                        if d not in [i, o, p, a, s]:
                                            for m in range(10):
                                                ...
                                                if Temp[m] != 1 and matrix[d][m] == 1:
                                                    Temp[m] = matrix[d][m]
                                            if Temp == Cover:
                                                print(f"Покриття за {row_counter} рядків, а саме {(i+1), (o+1), (p+1), (a+1), (s+1), (d+1)} за ціну {cost}.")
                                                if row_counter < best_amount:
                                                    best_amount = row_counter
                                                    print("РЕКОРД КІЛЬКОСТІ")
                                                if cost < best_cost:
                                                ...
                                                if f not in [i, o, p, a, s, d]:
                                                    for m in range(10):
                                                        ...
                                                        if Temp[m] != 1 and matrix[f][m] == 1:
                                                            Temp[m] = matrix[f][m]
                                                    if Temp == Cover:
                                                        print(f"Покриття за {row_counter} рядків, а саме {(i+1), (o+1), (p+1), (a+1), (s+1), (d+1), (f+1)} за ціну {cost}.")
                                                        if row_counter < best_amount:
                                                            best_amount = row_counter
                                                            print("РЕКОРД КІЛЬКОСТІ")
                                                        if cost < best_cost:
